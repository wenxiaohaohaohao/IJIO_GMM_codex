...
output file=function_our_exogenous/GMM23_east_middle_core_ccity_entrant_ind3.out on;

@----------------Program options----------------------------------------@

instru=2;       @instru=0-11,instruments@
...
mtx="function_our_exogenous\\zeez_instru2_"$+ind;

@------save outputs here------@
cffs="function_our_exogenous\\parameter_instru2_"$+ind;
omi="function_our_exogenous\\g_instru2_"$+ind;
