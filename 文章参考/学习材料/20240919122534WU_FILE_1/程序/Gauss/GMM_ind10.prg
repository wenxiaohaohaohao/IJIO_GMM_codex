...
output file=function_our_exogenous/GMM23_east_middle_core_ccity_entrant_ind11.out on;

@----------------Program options----------------------------------------@

instru=9;       @instru=0-11,instruments@
...
mtx="function_our_exogenous\\zeez_instru9_"$+ind;

@------save outputs here------@
cffs="function_our_exogenous\\parameter_instru9_"$+ind;
omi="function_our_exogenous\\g_instru9_"$+ind;
...
xs=ct~dyear~age~east~middle~core~ccity~entrant~pol3(k,l,m)~wage~rml~scost1step~soe~dind;
return;
below:
gosub vardef;
