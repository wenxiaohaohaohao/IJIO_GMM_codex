...
if (g=="G1_17_19") {
    // 鍘熷厛 anchor=18 鐨?IV锛圞z=9锛?    Z = st_data(., ("const","llag","k","klag","l","lsq","mlag","lagS2q","mlagk"))
	printf(">> Using IV: IV_anchor18_Kz9\n")
}
else  {
    // 鍘熷厛 anchor=40 鐨?IV锛圞z=9锛?    Z = st_data(., ("const","llag","k","mlag","klag","l","lagS2q","llagklag","lsq","mlagk", "llagmlag" ))
