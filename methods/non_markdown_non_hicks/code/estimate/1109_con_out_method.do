...
* 鈥斺€?5) 鏈€鍚庡仛涓€鎶?榻愭椿"妫€鏌ワ紝缂鸿皝琛ヨ皝鎴栧墧鎺夋牱鏈?鈥斺€?
assert !missing(llag, klag, mlag, lsqlag, ksqlag, lages, lages2q, ///
...
if (g=="G1_17_19") {
    // 鍘熷厛 anchor=18 鐨?IV锛圞z=9锛?    Z = st_data(., ("const","llag","k","mlag","klag","l","lsq","lages","mlagk", "klages","firmcat_2","firmcat_3",
                               "lnage","dy2002","dy2003","dy2004","dy2005","dy2006","dy2007"))
	printf(">> Using IV: IV_anchor18_Kz9\n")
}
else  {
    // 鍘熷厛 anchor=40 鐨?IV锛圞z=9锛?     Z = st_data(., ("const","llag","k","mlag","klag","l","lages","llagklag","lsq","mlagk","klages", "llagmlag", "ksq" ,"firmcat_2","firmcat_3","lnage","dy2002","dy2003","dy2004","dy2005","dy2006","dy2007"))
