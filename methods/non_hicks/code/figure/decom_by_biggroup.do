...
* Optional: AFT construction if needed later (鍘熼€昏緫淇濈暀)
...
preserve
    ...
    * -------- Nicely formatted table in Stata only --------
    ...
    di as txt "{hline 120}"
    di as txt "Foreign-input cost share change 鈥?PATH (constant lines with b0,t0 for Const-Tech) vs SHAPLEY"
