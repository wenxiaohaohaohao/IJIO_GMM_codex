...
* ---- 5.3 firm-level 娈嬪樊 omega_hat / xi_hat 杈撳嚭 ---- *
...
if `RUN_DIAG' {
    ...
    * ---- 6.2 J 鍒嗚В鎵撳嵃锛堝鏋滀綘闇€瑕佺湅鍝竴涓?IV 鎷栦簡 J锛?---
    ...
    matrix list J_contrib        // 濡傛灉浣犲湪 Mata 涓繚鐣欎簡鐩稿簲鐭╅樀
    matrix list J_contrib_iv
    matrix list J_contrib_white

    local Kz = colsof(moments_opt)
    * 娉ㄦ剰锛氳繖閲岀洿鎺ョ敤 colnames(moments_opt) 鏇村畨鍏紝
    * 濡傛灉浣犱箣鍓嶅湪 Mata 閲岃缃簡 colnames(W_opt) 鎴?Z 鐨勫悕绉帮紝
    * 鍙互鐢ㄥ畠浠潵鏇夸唬鎵嬪姩鍐?Znames銆?}
