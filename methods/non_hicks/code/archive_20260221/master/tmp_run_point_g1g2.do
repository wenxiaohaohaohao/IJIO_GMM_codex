...
log using "methods/non_hicks/results/logs/tmp_point_G1G2_driver.log", text replace
...
file open fh using "methods/non_hicks/results/logs/tmp_point_G1G2_rc.txt", write replace
