...
if (g=="G1_17_19") {
    ...
    // 原先 anchor=40 的 IV（Kz=9）
     Z = st_data(., ("const","llag","k","mlag","klag","l","lages","llagklag","lsq","mlagk","klages", "llagmlag", "ksq" ,"firmcat_2","firmcat_3","lnage","dy2002","dy2003","dy2004","dy2005","dy2006","dy2007"))
