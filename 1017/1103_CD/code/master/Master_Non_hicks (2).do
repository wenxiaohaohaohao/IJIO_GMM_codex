...
order group  b_const se_const  b_l se_l b_k se_k b_m se_m b_x se_x J_unit J_opt N
compress
save "$RES_DATA/nonhicks_points_by_group.dta", replace

* 3) Also emit SE-only table (optional)
preserve
    keep group se_const se_l se_k  se_m  se_x
    compress
...
order cic2 group b_const se_const b_l se_l b_k se_k b_m se_m b_x se_x 
