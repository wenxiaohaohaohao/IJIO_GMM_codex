...
* 导出图片（可改为 .pdf/.tif）
graph export "aft_by_biggrp.png", replace
restore
...
graph export "aft_index_by_biggrp.png", width(2400) replace
...
* 导出
graph export "aft_wmean_index.png", name(fig_aft_wmean_index) width(2400) replace
