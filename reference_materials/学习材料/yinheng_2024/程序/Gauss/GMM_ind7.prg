...
output file=function_our_exogenous/GMM23_east_middle_core_ccity_entrant_ind8.out on;

@----------------Program options----------------------------------------@

instru=3;       @instru=0-11,instruments@
...
mtx="function_our_exogenous\\zeez_instru3_"$+ind;

@------save outputs here------@
cffs="function_our_exogenous\\parameter_instru3_"$+ind;
omi="function_our_exogenous\\g_instru3_"$+ind;
